...
class Level:
    def __init__(self, current_level, surface, creeate_overworld, change_coins, change_health):
        self.display_surface = surface
        self.world_shift = 0
        self.current_x = None

        self.coin_sound = pygame.mixer.Sound('../audio/effects/coin.wav')
        self.coin_sound.set_volume(0.04)
        self.stomp_sound = pygame.mixer.Sound('../audio/effects/stomp.wav')
        self.stomp_sound.set_volume(0.04)

        self.create_overworld = creeate_overworld
